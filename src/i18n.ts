...
const dict = {
  ...
  panoramaControl: { kk: 'Панорама көрсеткіші', ru: 'Панорамный человечек' },
  panoramaUnavailable: {
    kk: 'Бұл жоспар үшін панорама әлі жоқ',
    ru: 'Для этого плана панорамы пока нет',
  },
  panoramaLoad: { kk: 'Панораманы жүктеу', ru: 'Загрузить панораму' },
  panoramaLoading: { kk: 'Панорама жүктелуде…', ru: 'Загрузка панорамы…' },
  panoramaError: {
    kk: 'Панораманы көрсету мүмкін болмады',
    ru: 'Не удалось показать панораму',
  },
  panoramaBack: { kk: 'Картаға оралу', ru: 'Назад к карте' },
  panoramaNoDrop: {
    kk: 'Белгіге тастаңыз немесе белгіні таңдаңыз',
    ru: 'Перетащите на метку или выберите её',
  },
  panoramaInstructions: {
    kk: 'Қарау үшін сүйреңіз немесе бағыттау пернелерін, масштабтау үшін + / − пернелерін пайдаланыңыз.',
    ru: 'Перетаскивайте или используйте клавиши со стрелками для обзора, + / − для масштаба.',
  },
} as const;
