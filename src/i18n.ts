...
const dict = {
  ...
  sectionLabel: { kk: 'Жоспар түрі', ru: 'Тип плана' },
  horizontalSection: { kk: 'Көлденең жоспар', ru: 'Горизонтальный план' },
  lShapedSection: { kk: 'L-тәрізді жоспар', ru: 'L-образный план' },
